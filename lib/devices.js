...
function setObjectNotExists(id, newObj, callback) {
    getObject(id, {}, function (err, o) {
        ...
        typeof callback === 'function' && callback(/**'exists'*/null, o);
    });
}
...
function Devices(adapter, onReady) {
    ...
    this.getobjex = function (id) {
        ...
        if (obj || !adapter.namespace) return obj;
    ...
    this.createObjectNotExists = function (id, obj, callback) {
        ...
        setObjectNotExists(id, newobj, (err, o) => {
            if (!err) {
    ...
    this.update = function (list, callback) {
        ...
        forEachObjSync(list, (obj, doit) => that.setStateEx(obj._id, obj, true, doit),
            callback);
    };
